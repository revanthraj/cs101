...
int main()
{
            ...
            initCanvas("SUDOKU QUEST",500,500);for(int i=0;i<9999;i++){
             Rectangle r1(250,200,150,50); r1.setColor(COLOR(200,0,0)); r1.setFill();
             Rectangle r2(250,260,150,50); r2.setColor(COLOR(200,0,0)); r2.setFill();
             Rectangle r3(250,320,150,50); r3.setColor(COLOR(200,0,0)); r3.setFill();
             Text s1(250,100,"SUDOKU");
             Text a1(250,200,"Sudoku Autosolver");
             ...
             s1.hide();a1.hide();g1.hide();i1.hide();r1.hide();r2.hide();r3.hide();
           ...
           Rectangle back(250,400,100,50);Text b1(250,400,"BACK");
           int getpo=getClick();
           int x3,y3;
           x3=getpo/65536;y3=getpo%65536;
           if(x3<=300&&x3>=200&&y3>=375&&y3<=425){break;}
wait(200);
}}}}
void selectSudoku(Text *t0, int matrix[9][9], int grid[9][9] ,char str[82])

{
    ...
    char l;
    int k1;int k2;
    cout<<"Enter a level :'E' for easy and 'D' for Difficult : ";
    cin>>l;
    FILE *fp;
    ...
    k2=  (rand() % 7)+8 ;
        ...
        if(l!='E' && l!='D') {cout<<"Bad input!"<<endl; return ;}
        else if(l=='E')
        {
            switch(k1){
